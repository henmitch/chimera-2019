...
parser.add_argument(
    "-min", metavar="min", type=float, nargs=1, default=-1.5,
    help="The minimum potential value (defaults to -1.5)"
)
parser.add_argument(
    "-max", metavar="max", type=float, nargs=1, default=2,
    help="The maximum potential value (defaults to 2)"
)
parser.add_argument(
