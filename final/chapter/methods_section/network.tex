...
\begin{figure*}[ht]
  \centering
  \subfloat[Matrix representation\label{fig:mouse_matrix}]{
    \centering
    \includegraphics[width=0.45\textwidth]{figure/n}
  } \hfill
  \subfloat[Embedding\label{fig:mouse_embedding}]{
    \centering
    \includegraphics[width=0.45\textwidth]{figure/network}
  }
...
\begin{figure}[ht]
  \centering
  \subfloat[$n'$ and $n''$\label{fig:n_prime}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/n_prime}
  }

  \subfloat[$G'$ and $G''$\label{fig:g_prime}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/g_prime}
  }
...
\begin{figure}[ht]
  \centering
  \subfloat[All values\label{fig:g_over_n}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/g_over_n}
  }

  \subfloat[Dropped zeros\label{fig:g_over_n_drop}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/g_over_n_drop}
  }
