...
along with measured connection strengths between the subcortices [\onlinecite{Oh2014}].
...
\begin{equation}
  ...
  \end{cases}
\end{equation}
where $O_{j k}$ is the raw connection strength provided by [\onlinecite{Oh2014}].
We performed this simplification to match the analysis of Santos \etal more closely [\onlinecite{Santos2017}].

We show $G$ in \cref{fig:mouse_connectome}, and break it down into its inter- and intra-connections in \cref{fig:primes}.
This brain network is a small-world network [\onlinecite{Oh2014}],
a graph topology which lends itself well to the development of chimera states, as it facilitates nonlocal coupling [\onlinecite{Hizanidis2016}].
\onecolumngrid
