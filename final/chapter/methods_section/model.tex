The model used for this work was the modified Hindmarsh-Rose neural model\footnote{The modification is to add in the coupling, turning it into a network model instead of a single neuron.} taken from [\onlinecite{Santos2017}].
\begin{align}
  \begin{split}
  \label{eq:hr_x}
  \dot{\hrx}_{j}
...
\begin{table}[ht]
  \centering
  \begin{tabular}{c | c | p{0.33\textwidth}}
