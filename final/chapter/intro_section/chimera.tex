...
\begin{figure*}[ht]
  \centering
  \subfloat[The time series of the Kuramoto simulation.\label{fig:kuramoto_overhead}]{
    \centering
    \includegraphics[width=0.6\textwidth]{figure/kuramoto_overhead}
  } \hfill
  \subfloat[A snapshot at $t = 120$.\label{fig:kuramoto_snapshot}]{
    \centering
    \includegraphics[width=0.3\textwidth]{figure/kuramoto_snapshot}
  }
...
\begin{figure*}[ht]
  \centering
  \subfloat[The time series of the Abrams simulation.\label{fig:abrams_overhead}]{
    \centering
    \includegraphics[width=0.6\textwidth]{figure/abrams_overhead}
  } \hfill
  \subfloat[A snapshot at $t \approx 800$.\label{fig:abrams_snapshot}]{
    \centering
    \includegraphics[width=0.3\textwidth]{figure/abrams_snapshot}
  }
  \caption[Abrams simulation]{A simulation of the Abrams model for two populations of 128 oscillators.
    ...
    (b) shows a snapshot at $t \approx 800$.
  }
  \label{fig:abrams}
\end{figure*}
