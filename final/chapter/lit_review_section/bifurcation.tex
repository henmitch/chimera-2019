...
\begin{figure}[ht]
  \centering
  \subfloat[\label{fig:wc}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/wc}
  } \hfill
  \subfloat[\label{fig:swe}]{
    \centering
    \includegraphics[width=0.9\columnwidth]{figure/swe}
  }
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{figure/wc_bifurcation}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{figure/epileptor}
