...
\begin{figure}[ht]
  ...
  \caption[Typical EEG trace]{A typical EEG trace.
    ...
    Taken from [\onlinecite{Ljungberg2009}].
  }
  \label{fig:eeg}
\end{figure}
...
One of the main challenges of simulating seizures is that only trained experts can truly identify seizures; as yet, there is no mathematical technique for identifying seizures [\onlinecite{Kandel2013}].
