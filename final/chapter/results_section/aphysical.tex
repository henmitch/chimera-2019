The reason which figures are not included for the first two parameter sweeps of \cref{tab:parameter_sweeps} is that a large portion of parameter space leads to an aphysical model.
